...
dom.toggleProductListBtn?.addEventListener("click", () => {
  ui.productListOpen = !ui.productListOpen;
  try {
    localStorage.setItem(PRODUCT_LIST_OPEN_KEY, ui.productListOpen ? "1" : "0");
  } catch (_) {}
...
function init() {
  ...
  loadLocal();
  try {
    ui.productListOpen = localStorage.getItem(PRODUCT_LIST_OPEN_KEY) === "1";
  } catch (_) {
